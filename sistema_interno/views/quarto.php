                ...
                <div id="container_cad_paciente">
                    ...
                    <div class="col_2">
                        <div class="titulo_tabela">
                            ...
                            <div class="lb_titulo">NUMERO</div>
                        ...
                        <?php
                            ...
                            include_once('../models/quarto_class.php');
                                ...
                                $list = $controller_quarto::ListarTipoQuarto();
                        ...
                        ?>
                                    <div class="linha_tabela">
                                        ...
                                        <div class="item_tabela"><?= $list[$cont]->numero ?></div>
                                        <div class="item_tabela icones_tabela">

                                            <a href="#" class="editar" onclick="Editar(<?php echo($list[$cont]->id_quarto);?>)">
                                                <img src="../imagens/edit.png" alt="editar" title="editar">
                                            </a>
                                            <a href="#" class="excluir" onclick="Excluir(<?php echo($list[$cont]->id_quarto);?>)">
