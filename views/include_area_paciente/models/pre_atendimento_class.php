...
class Pre_Agendamento
{
    ...
    public function Insert($dados_agendamento){
        //variavel sql
        $sql = "INSERT INTO tbl_pre_atendimento(id_paciente,id_funcionario,id_unidade,data,hora)
        VALUES ('".$dados_agendamento->id_paciente."',
          '".$dados_agendamento->id_funcionario."', '".$dados_agendamento->id_unidade."',
          '".$dados_agendamento->data."','".$dados_agendamento->hora."');";
